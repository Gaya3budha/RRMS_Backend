...
from .views import FolderTreeAPIView,MoveFilesAPIView,ArchiveFileAPIView,MergecaseAPIView,UnArchiveFileAPIView,FolderTreeFullAPIView,CopyFilesAPIView,ArchiveFullTreeAPIView
...
path('merge',MergecaseAPIView.as_view())
]
